...
<!-- ![alt text](temp/secret-by-doppler.excalidraw.png) -->

<!-- ## Sơ đồ CICD bằng Github Action -->

<!-- ![alt text](temp/cicd-by-github-action.excalidraw.png) -->

<!-- ## Sơ đồ quản lý Kong API Gateway -->

<!-- ![alt text](temp2/Deck-CICD-Kong-API-Gateway.excalidraw.png) -->

<!-- ## Sơ đồ Infrastructure as Code (IaC) sử dụng terraform -->

<!-- ![alt text](temp2/infrastructure-as-code-IaC-terraform.excalidraw.png) -->
...
<!-- ![alt text](temp/Data-Pipeline.excalidraw.png) -->

<!-- ## Sơ đồ thu thập dữ liệu -->

<!-- ![alt text](temp/crawl-data.excalidraw.png) -->
