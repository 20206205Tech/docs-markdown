...
Xác thực & Phân quyền (Authentication), Xác thực 2 yếu tố (Multi-Factor Authentication - MFA), Quản lý dữ liệu người dùng (Database REST API)
...
Tham khảo https://supabase.com/docs/guides/auth/auth-mfa/totp

![alt text](auth-mfa-flow.svg)

Chi tiết về cấu hình terraform
Chi tiết về cấu hình migration
Chi tiết về gói thư viện dùng chung NestJS (npm) và FastAPI (python)
